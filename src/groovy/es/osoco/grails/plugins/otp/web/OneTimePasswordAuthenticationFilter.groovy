 ...
 */
class OneTimePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    String usernameParameter = SPRING_SECURITY_OTP_FORM_USERNAME_KEY
    String passwordParameter = SPRING_SECURITY_OTP_FORM_OTP_KEY
